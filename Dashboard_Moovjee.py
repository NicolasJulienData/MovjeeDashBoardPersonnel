...
with col14:
    ...
    fig = px.line(data_graph, x="date", y="likes", color="title", hover_data=['title','likes','views','description'], 
              title = 'Suivi général du nombre de Likes', log_y=False, height=650, width = 1050, labels={'title':'Projet', 'likes':"Number of Likes"}, markers = True, category_orders={'date':data.sort_values(by=['date'], ascending = False)['date']})
    st.write(fig)
